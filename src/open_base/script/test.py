...
NORTH = list(range(80, 100))

SOUTH = list(range(-100, -80))
WEST = list(range(170, 180))
WEST.extend(range(-180, -170))
EAST = list(range(0, 10))
EAST.extend(range(-10, 0))
direction= NORTH
done = bool(90 in NORTH)
agent_pose = 78
sdafdsf = list(range(np.min(direction) - 1, np.min(direction) - 10,-1))
               # if agent_pose in range(np.min(direction) - 1, np.min(direction) - 10):
print(sdafdsf)
...
#         done = bool(self.agent_pos in range NORTH)
#
